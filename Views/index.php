...
<body style="background-image: linear-gradient(to right, rgba(10,0,0,0), rgb(192,192,192))));">

<nav class="navbar navbar-expand-sm bg-primary navbar-dark">
  <a class="navbar-brand" href="#">IPD Framewoks</a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url(); ?>/Dashboard">Ir a Administrar</a>
      </li>
    </ul>
  </div>
</nav>
